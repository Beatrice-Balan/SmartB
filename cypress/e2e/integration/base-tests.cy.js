...
describe('Base test @Smoke', () => {
    ...
    const rightPanelHeadings = ["List of All Orders", "List of Products", "Order"]
        ...
        for(let i = 0; i <= 2; i++) {
           ...
           // expect(el.text()).eq(leftPanelOptions[index])
           // basePage.getRightPanelHeading.should('include.text', rightPanelHeadings[index])
           // basePage.getRightPanelMainContentTable()
